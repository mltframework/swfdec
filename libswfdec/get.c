...
void
get_art_color_transform (bits_t * bits, double mult[4], double add[4])
{
  int has_add;
  int has_mult;
  int n_bits;
...
void
get_art_matrix (bits_t * bits, double *trans)
{
  int has_scale;
  int n_scale_bits;
  int scale_x = 0;
...
void
get_color_transform (bits_t * bits)
{
  int has_add;
  int has_mult;
  int n_bits;
