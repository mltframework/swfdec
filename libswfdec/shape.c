...
void
swfdec_shape_free (SwfdecObject * object)
{
  _swfdec_shape_free (object->priv);
}

void
_swfdec_shape_free (SwfdecShape * shape)
{
...
SwfdecLayer *
swfdec_shape_prerender (SwfdecDecoder * s, SwfdecSpriteSeg * seg,
