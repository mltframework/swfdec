...
#define SWFDEC_AS_STR__parent		SWFDEC_AS_STR_CONSTANT(61)
#define SWFDEC_AS_STR__root		SWFDEC_AS_STR_CONSTANT(62)
#define SWFDEC_AS_STR_HASH_ERROR	SWFDEC_AS_STR_CONSTANT(63)
#define SWFDEC_AS_STR_NUMBER		SWFDEC_AS_STR_CONSTANT(64)
#define SWFDEC_AS_STR_BOOLEAN		SWFDEC_AS_STR_CONSTANT(65)
#define SWFDEC_AS_STR_STRING		SWFDEC_AS_STR_CONSTANT(66)
#define SWFDEC_AS_STR_MOVIECLIP		SWFDEC_AS_STR_CONSTANT(67)
#define SWFDEC_AS_STR_FUNCTION		SWFDEC_AS_STR_CONSTANT(68)
#define SWFDEC_AS_STR_OBJECT		SWFDEC_AS_STR_CONSTANT(69)
#define SWFDEC_AS_STR_toString		SWFDEC_AS_STR_CONSTANT(70)
#define SWFDEC_AS_STR_valueOf		SWFDEC_AS_STR_CONSTANT(71)
#define SWFDEC_AS_STR_Function		SWFDEC_AS_STR_CONSTANT(72)
#define SWFDEC_AS_STR_prototype		SWFDEC_AS_STR_CONSTANT(73)
#define SWFDEC_AS_STR_constructor	SWFDEC_AS_STR_CONSTANT(74)
...
#define SWFDEC_AS_STR_Number		SWFDEC_AS_STR_CONSTANT(88)
#define SWFDEC_AS_STR_NAN		SWFDEC_AS_STR_CONSTANT(89)
#define SWFDEC_AS_STR_MAX_VALUE		SWFDEC_AS_STR_CONSTANT(90)
#define SWFDEC_AS_STR_MIN_VALUE		SWFDEC_AS_STR_CONSTANT(91)
#define SWFDEC_AS_STR_NEGATIVE_INFINITY	SWFDEC_AS_STR_CONSTANT(92)
#define SWFDEC_AS_STR_POSITIVE_INFINITY	SWFDEC_AS_STR_CONSTANT(93)
#define SWFDEC_AS_STR_type_Object	SWFDEC_AS_STR_CONSTANT(94)
#define SWFDEC_AS_STR_startDrag		SWFDEC_AS_STR_CONSTANT(95)
#define SWFDEC_AS_STR_Mouse		SWFDEC_AS_STR_CONSTANT(96)
#define SWFDEC_AS_STR_hide		SWFDEC_AS_STR_CONSTANT(97)
...
#define SWFDEC_AS_STR_registerClass	SWFDEC_AS_STR_CONSTANT(124)
