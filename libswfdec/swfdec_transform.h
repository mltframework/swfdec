...
gboolean swfdec_transform_is_translation (SwfdecTransform *a, SwfdecTransform *b);
void swfdec_transform_multiply (SwfdecTransform *dest, SwfdecTransform *a, SwfdecTransform *b);
...
void swfdec_transform_translate (SwfdecTransform *transform, double x, double y);
